...
- `config/noctalia/templates/` - leftover input for sddm. Nothing renders it under v5: it was fed to v4's user-template registry, which v5 removed. `monarch refresh sddm` is the live path.
