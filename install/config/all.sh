...
run_logged $MONARCH_INSTALL/config/hardware/fix-asus-rog-audio-mixer.sh
run_logged $MONARCH_INSTALL/config/hardware/fix-asus-rog-mic.sh
...
run_logged $MONARCH_INSTALL/config/hardware/framework16-qmk-hid.sh
