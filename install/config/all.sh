...
run_logged $MONARCH_INSTALL/config/powerprofiles.sh
...
run_logged $MONARCH_INSTALL/config/hardware/intel/video-acceleration.sh
...
run_logged $MONARCH_INSTALL/config/hardware/asus/fix-asus-ptl-display-backlight.sh
...
run_logged $MONARCH_INSTALL/config/hardware/apple/fix-spi-keyboard.sh
run_logged $MONARCH_INSTALL/config/hardware/apple/fix-suspend-nvme.sh
run_logged $MONARCH_INSTALL/config/hardware/apple/fix-t2.sh

run_logged $MONARCH_INSTALL/config/hardware/lenovo/fix-yoga-pro7-bass-speakers.sh
