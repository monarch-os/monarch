...
if monarch-hw-dell-xps-haptic-touchpad; then
  ...
  sudo rm -f /etc/monarch-dell-haptic-touchpad.env
  sudo systemctl daemon-reload
  sudo udevadm control --reload-rules

  source "$MONARCH_PATH/install/packaging/dell-xps-touchpad-haptics.sh"
fi
