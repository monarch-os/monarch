--
-- Dynamic Monarch Theme Menu for Elephant/Walker
--
Name = "monarchthemes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/monarch/themes"
  local monarch_path = os.getenv("MONARCH_PATH") or ""
  local default_theme_dir = monarch_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "monarch-theme-set " .. theme_name,
            },
          })
        end
      end
