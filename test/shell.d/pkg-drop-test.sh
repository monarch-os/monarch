...
: >"$TEST_PACMAN_LOG"
"$ROOT/bin/monarch-pkg-drop" --help
[[ $(wc -l <"$TEST_PACMAN_LOG") == 1 ]] ||
  fail "an option-like missing package is never sent to pacman"
pass "package retirement treats option-like names literally"
