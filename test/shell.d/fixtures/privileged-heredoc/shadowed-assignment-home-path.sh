...
target=/usr/share/monarch/bin/agent
target="$HOME/.local/share/monarch/bin/agent"

# monarch:heredoc-expands paths=none -- target is the packaged agent path under /usr
